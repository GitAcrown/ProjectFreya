...
class Payday:
    ...
    def __init__(self, bot):
        ...
        self.good = [["{} prépare le voiture, prêt à partir +25 points.", 25],
                     ...
                     ["{} hack le systeme de sécurité et remplace la vidéo par Vitas - 7th Element +75 points", 75],
                     ["{} se sert d'un maternelle passé par là comme bouclier +25 points", 25],
                     ["{} appelle Madmoizelle en indiquant que le policier est un Male hetero blanc cis +50 points", 50],
        ...
        self.bad = ["Un tir à eu lieu avec la police locale et {} est touché." + "\n" +
                    ...
                    "`{} hors jeu.`",
                    "{} se fait tabasser par un civil go-muscu et le crew semble être déjà parti." + "\n" +
                    "`{} hors jeu.`"]
...
def check_files():
    system = {"Players": {},
              "Config": {"Bankheist Started": "No", "Planning Heist": "No",
                         ...
                         "Min Bet": 0, "Wait Time": 100, "Bank Target": "",
                         "Vault Frequency": 120},
              "Heist Winners": {},
